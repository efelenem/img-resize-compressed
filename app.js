...
async function imgUpload(img) {
    const uploadedImage = img.files[0];
    ...
    const MAX_WIDTH = 700; //if we resize by width, this is the max width of compressed image
    const MAX_HEIGHT = 700; //if we resize by height, this is the max height of the compressed image
